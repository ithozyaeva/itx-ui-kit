import{t as e}from"./Typography-CFUkqPRN.js";var t={components:{TypographyComponent:e},title:`Atoms/Typography`,argTypes:{variant:{control:{type:`select`},options:[`h1`,`h2`,`h3`,`h4`,`price`,`body-xl`,`body-l`,`body-m`,`body-x`,`body-xs`,`title`,`label`,`button-text`]},as:{control:{type:`select`},options:[`h1`,`h2`,`h3`,`h4`,`p`,`span`,`label`,`div`,`title`]},text:{control:{type:`text`}}},args:{as:`p`,variant:`body-l`,text:`The quick brown fox jumps over the lazy dog.`}};const n={render:t=>({components:{TypographyComponent:e},setup(){return{args:t}},template:`
