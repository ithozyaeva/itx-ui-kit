import{S as e,T as t,a as n,b as r,f as i,g as a,k as o,l as s,u as c,v as l,y as u}from"./iframe-8Rhg1J6g.js";import{t as d}from"./Typography-wtgyx33M.js";import{t as f}from"./_plugin-vue_export-helper-BKxlXpAG.js";var p=c({__name:`MenuItem`,props:{as:{default:`a`},variant:{default:`default`}},setup(t){let c=r();return(r,f)=>(a(),n(u(t.as),i({class:[`menu-item`,[t.variant]]},o(c)),{default:e(()=>[s(o(d),{variant:`button-text`},{default:e(()=>[l(r.$slots,`default`,{},void 0,!0)]),_:3})]),_:3},16,[`class`]))}}),m=f(p,[[`__scopeId`,`data-v-a4fc34ad`]]);p.__docgenInfo={exportName:`default`,displayName:`MenuItem`,description:``,tags:{},props:[{name:`as`,required:!1,type:{name:`AsProp`},defaultValue:{func:!1,value:`'a'`}},{name:`variant`,required:!1,type:{name:`MenuItemVariant`},defaultValue:{func:!1,value:`'default'`}}],slots:[{name:`default`}],sourceFiles:[`/home/runner/work/itx-ui-kit/itx-ui-kit/src/components/atoms/MenuItem.vue`]};var h={title:`Atoms/MenuItem`,component:m,argTypes:{variant:{control:{type:`select`},options:[`active`,`default`]},as:{control:{type:`text`}}},args:{as:`a`,variant:`default`}};const g={render:e=>({components:{MenuItemComponent:m},setup(){let n=t(!1);return{args:e,active:n,toggleActive:()=>{n.value=!n.value}}},template:`<MenuItemComponent as="a" v-bind="args" href="#foo" :variant="active ? 'active' : 'default'" @click="toggleActive">Foo Item</MenuItemComponent>
